        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <ul>
                <li>
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Zonal Office</span>
                    </Link>
                </li>
            </ul>
            <ul>
                <a href="#"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Area Office</span>
                </a>
            </ul>
            <ul>
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Branch Office</span>
                    </a>
                </li>
                <li>
                    <button type="button"
